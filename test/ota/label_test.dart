...
void main() {
  ...
  group('Label instantiation', () {
    ...
    test('Test instantiation with constructor when named args are passed', () {
      var label = LabelTr(key: 'key', value: 'value');
    ...
    test(
        ...
        () {
      var label = LabelTr.fromJson({'key': 'key'});
    ...
    test('Test instantiation with named constructor when json arg has all data',
        () {
      var label = LabelTr.fromJson({'key': 'key', 'value': 'value'});
  ...
  group('Label literal translation', () {
    ...
    test('Test label literal translation when value contains a tag', () {
      var label =
          LabelTr(key: 'key', value: 'Literal message with a <b>tag</b>.');
    ...
    test(
        ...
        () {
      var label = LabelTr(
          key: 'key', value: '<p>Literal message with a <b>tag</b>.</p>');
    ...
    test('Test label literal translation when value contains a less-than sign',
        () {
      var label = LabelTr(key: 'key', value: 'Literal message with < sign');
  ...
  group('Label argument translation', () {
    test('Test label argument translation when value contains just placeholder',
        () {
      var label = LabelTr(key: 'key', value: '{placeholder}');
    ...
    test(
        ...
        () {
      var label = LabelTr(key: 'key', value: 'Hi {name}!');
